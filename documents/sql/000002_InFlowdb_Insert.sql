...
INSERT INTO [dbo].[Entity] (ObjectName, Phone, Email, Fax, BillingAddressID, ShippingAddressID, CustomerTypeID, ObjectTypeID, TotalSpend, LastOrderDate, CreatedBy, UpdatedBy, IsActive, CompanyName, Website)
 VALUES
 (N'Nguyen Van A', '0901234567', 'nguyenvana@example.com', '5551234567', 1, 2, 5, 7, 500.50, '2025-09-01', 1, 1, 1, NULL, NULL),
 (N'Tran Thi B', '0912345678', 'tranthib@example.com', '5551234568', 3, 4, 5, 7, 1200.75, '2025-08-15', 1, 1, 1, NULL, NULL),
 (N'Le Van C', '0923456789', 'levanc@example.com', '5551234569', 5, 6, 6, 8, 3000.00, '2025-09-02', 1, 1, 1, N'Le Van Corporation', N'www.levancorp.vn'),
 (N'Pham Thi D', '0934567890', 'phamthid@example.com', '5551234570', 7, 8, 6, 8, 450.25, '2025-08-20', 1, 1, 1, N'Pham Thi Ltd', N'www.phamthiltd.vn'),
 (N'Hoang Van E', '0945678901', 'hoangvane@example.com', '5551234571', 9, 10, 5, 7, 750.00, '2025-09-03', 1, 1, 1, NULL, NULL),
 (N'Nguyen Thi F', '0956789012', 'nguyenthif@example.com', '5551234572', 1, 2, 5, 7, 1800.90, '2025-08-10', 1, 1, 1, NULL, NULL),
 (N'Tran Van G', '0967890123', 'tranvang@example.com', '5551234573', 3, 4, 6, 8, 2500.60, '2025-09-04', 1, 1, 1, N'Tran Van Group', N'www.tranvangroup.vn'),
 (N'Le Thi H', '0978901234', 'lethih@example.com', '5551234574', 5, 6, 5, 7, 600.30, '2025-08-25', 1, 1, 1, NULL, NULL),
 (N'Pham Van I', '0989012345', 'phamvani@example.com', '5551234575', 7, 8, 6, 8, 900.80, '2025-09-05', 1, 1, 1, N'Pham Van Enterprises', N'www.phamvanenterprises.vn'),
 (N'Hoang Thi K', '0990123456', 'hoangthik@example.com', '5551234576', 9, 10, 5, 7, 1500.45, '2025-08-30', 1, 1, 1, NULL, NULL);
GO
